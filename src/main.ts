...
import { faUser, faBell, faMapMarkerAlt, faFilter, faUserPlus, faSignInAlt, faMapPin, faMapLocationDot, faClock, faMobile, faCalendar, faTrash, faMap, faEye, faXmark, faPlay, faStop, faPersonRunning, faPerson } from '@fortawesome/free-solid-svg-icons';
